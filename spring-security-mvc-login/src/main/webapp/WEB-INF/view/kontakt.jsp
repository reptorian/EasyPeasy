	             ...
	             <nav class="navbar navbar-default">
					<div class="container-fluid">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="<c:url value="/kontakt.html" />">Kontakt</a></li>
		  ...
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li class="current"><a href="<c:url value="/kontakt.html" />"><i class="glyphicon glyphicon-earphone"></i> Kontakt</a></li>
                </ul>
             </div>
		  </div>
...
<!--podpiac mape-->
		  			<div id="google-map">
	                    <a href="#">
	                       <span>
	                           <img src="<c:url value="/static/images/placeholder.jpg" />" alt="mapa google">
	                       </span>
	                    </a>
					</div>
		  		</div>
